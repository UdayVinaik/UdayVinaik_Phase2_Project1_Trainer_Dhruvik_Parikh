...
public class GetClassServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(classes != null) {
			...
			out.print("<th> Subjects taught to class</th>");
			out.print("<th> Students study in class</th>");
			out.print("<th> Name of Teachers tech the class</th>");
			out.print("</tr>");
			...
			for(Class cl: classes) {
				...
				out.print("<td>"+cl.getSubjects()+"</td>");
				out.print("<td>"+cl.getStudents()+"</td>");
				out.print("<td>"+cl.getTeachers()+"</td>");
				out.print("</tr>");
			}
		}
	}
